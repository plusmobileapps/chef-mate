 ...
 *
 * Log messages at [Severity.Warn] and above with a non-null throwable are reported to Bugsnag via
 * [Bugsnag.notify]. All log messages are also sent as breadcrumbs to provide context for crash
 * reports.
 *
