...
// NOTE: identical to the iosMain twin (SubscriptionGateway.ios.kt). The purchases-kmp SDK exposes
// one common API for Android + iOS, but the default source-set hierarchy has no shared parent for
// the two, so the code is duplicated. Keep both files in sync.
