...
fun createRecipeSavedMessage(): TextData =
    ResourceString(Res.string.browser_recipe_saved)

fun createExtractionFailedMessage(): TextData =
    ResourceString(Res.string.browser_extraction_failed)
